...
you should place your code here."
  (global-linum-mode t)
  ;; Copied from:  http://stackoverflow.com/questions/12262220/add-created-date-property-to-todos-in-org-mode
